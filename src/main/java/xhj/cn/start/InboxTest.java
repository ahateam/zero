...
//		primaryKeyBuilder.addPrimaryKeyColumn("taskId", PrimaryKeyValue.fromLong(123));
//		primaryKeyBuilder.addPrimaryKeyColumn("recordId", PrimaryKeyValue.AUTO_INCREMENT);
//		RowPutChange putChange = new RowPutChange("ImportTempRecord", primaryKeyBuilder.build());
////
////		// 添加一些列
////		for (int i = 0; i < 10; i++) {
...
//		}
//		BatchWriteRowResponse batchWriteRow = client.batchWriteRow(batchWriteRowRequest);
//
...
//		// 设置起始主键
//		PrimaryKey pkStart = new PrimaryKeyBuilder().add(PK1, 123).add(PK2, ).build();
//
//		// 设置结束主键
//		PrimaryKey pkEnd = new PrimaryKeyBuilder().add(PK1, 123).add(PK2, ).build();// 不包含此id列
//
//		try {
//			JSONArray range = cateInfoRepository.getRange(client, pkStart, pkEnd, 512, 0);
